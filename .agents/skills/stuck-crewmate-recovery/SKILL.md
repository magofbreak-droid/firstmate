...
An exact-head PR check recorded for the crew's current branch remains authoritative when the endpoint is dead: handle terminal green or diagnostic failure through the normal lifecycle instead of creating a duplicate worker.
