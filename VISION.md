...
firstmate is the command layer, not the workshop: active normal validation belongs to bounded direct-PR and its canonical verifier, no-mistakes remains explicitly inactive migration compatibility, CI belongs to the forge, and merge policy belongs to the configured authority.
